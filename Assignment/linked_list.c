...
**  Purpose: Implementation of a generic double ended, doubly-linked list
**     Date: 20/10/19
**  ==========================================================================
*/

/* An older version of this code was previosuly submitted by me for P7 of 
 * UCP */
...
void insertFirst( LinkedList* list, void* inValue )
{
    ...
    ListNode* prevHead;
        /* The previous head of the list, it's prev needs to be set to 
         * newNode */
...
void insertLast( LinkedList* list, void* inValue )
{
    ListNode* newNode = (ListNode*)malloc( sizeof(ListNode) );
        /* New node to insert */
    ListNode* prevTail;
        /* The previous tail of the list, it's next needs to be set to 
         * newNode */
...
{
    ListNode* currNode;
        /* Current node to free */
    ListNode* nextNode;
        /* The node after currNode */
